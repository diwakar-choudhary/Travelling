...
ScrollReveal().reveal(".header__content .wrapper", {
  ...scrollRevealOption,
  delay: 2500,
});
...
ScrollReveal().reveal(".service__card1", {
  duration: 1000,
  interval: 500,
});
...
ScrollReveal().reveal(".trip__content .section__subheader1", {
  ...scrollRevealOption,
  delay: 500,
});
ScrollReveal().reveal(".trip__content .section__header1", {
  ...scrollRevealOption,
  delay: 1000,
});
...
ScrollReveal().reveal(".client__content .section__subheader1", {
  ...scrollRevealOption,
});
ScrollReveal().reveal(".client__content .section__header1", {
  ...scrollRevealOption,
  delay: 500,
});
